...
figure(7)
subplot(1,3,1); %MC
area(COMP.data(:,1),COMP.data(:,2),'FaceColor',[.85 .85 .85],'EdgeColor','none')
hold on;
plot(COMP.data(:,1),COMP.data(:,2),'g','LineWidth', 2)
plot(Nsame.data(:,1),Nsame.data(:,2),'r--','LineWidth', 2)
plot(Nopt.data(:,1),Nopt.data(:,2),'k','LineWidth', 1)
ylim([0 1])
xlabel ('Time (hr)','FontName','Times New Roman','FontSize',sz)
ylabel ('Concentration (g/m³)','FontName','Times New Roman','FontSize',sz)
title('MC')
set(gca,'XTick',[0:2:8])
set(gca,'Position',[0.1 0.125 0.29 0.8])
box on;
...
area(COMP.data(:,1),COMP.data(:,2),'FaceColor',[.85 .85 .85],'EdgeColor','none')
hold on;
plot(COMP.data(:,1),COMP.data(:,3),'g','LineWidth', 2)
plot(Nsame.data(:,1),Nsame.data(:,3),'r--','LineWidth', 2)
plot(Nopt.data(:,1),Nopt.data(:,3),'k','LineWidth', 1)
ylim([0 1])
xlabel ('Time (hr)','FontName','Times New Roman','FontSize',sz)
%ylabel ('Concentration (g/m³)','FontName','Times New Roman','FontSize',sz)
title('STS')
set(gca,'YTickLabel',[]);
set(gca,'XTick',[0:2:8])
set(gca,'Position',[0.4 0.125 0.29 0.8])

subplot(1,3,3); %HTS
hold on;
plot(COMP.data(:,1),COMP.data(:,4),'g','LineWidth', 2)
plot(Nsame.data(:,1),Nsame.data(:,4),'r--','LineWidth', 2)
plot(Nopt.data(:,1),Nopt.data(:,4),'k','LineWidth', 1)
area(COMP.data(:,1),COMP.data(:,2),'FaceColor',[.85 .85 .85],'EdgeColor','none')
plot(COMP.data(:,1),COMP.data(:,4),'g','LineWidth', 2)
plot(Nsame.data(:,1),Nsame.data(:,4),'r--','LineWidth', 2)
plot(Nopt.data(:,1),Nopt.data(:,4),'k','LineWidth', 1)
...
set(gca,'YTickLabel',[]);
set(gca,'XTick',[0:2:8])
set(gca,'Position',[0.7 0.125 0.29 0.8])
hl = legend('C2-SZ','N2-SZ','Opt N2-SZ');
set(hl,'fontsize',sz)
box on;
...
set(gcf,'PaperType','usLetter','PaperOrientation','portrait',...
        'PaperUnits','Inches','PaperPositionMode','Manual') 
set(gcf,'PaperPosition',[0 0 8 3],'Position',[100 100 800 300]) 

print('-dpng','-r200','Figure3.png')
print('-depsc2','-r900','Figure3.eps')
...
ylab{2} = 'Concentration (mg/L)';
xlab{1} = 'Time Elapsed (hr) ';

figure(7); 
subplot(3,3,1);%LAU1
hold on;
plot (OMC1(2:size(OMC1,1),1),OMC1(2:size(OMC1,1),2),'o','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C1.data(:,1),C1.data(:,2),'g','LineWidth',lwt);
plot (N1.data(:,1),N1.data(:,2),'r--','LineWidth',lwt);
plot (S1.data(:,1),S1.data(:,2),'k','LineWidth',lwt/2);
xlim([5 15])
ylim([0 20])
ylab{1}='Main Channel';
title('25 Jun 2008 0400 EST');
set(gca,'XTickLabel',{''});
ylabel(ylab,'FontName','Times New Roman','FontSize',sz)
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.1 0.69 0.28 0.28])
hl=legend('Observed', 'C2-SZ', 'N2-SZ', '1-SZ');
set(hl,'fontsize',sz)

subplot(3,3,2); %LAU2
hold on;
plot (OMC2(2:size(OMC2,1),1),OMC2(2:size(OMC2,1),2),'o','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C2.data(:,1),C2.data(:,2),'g','LineWidth',lwt);
plot (N2.data(:,1),N2.data(:,2),'r--','LineWidth',lwt);
plot (S2.data(:,1),S2.data(:,2),'k','LineWidth',lwt/2);
xlim([0 15])
ylim([0 20])
title('21 Jul 2008 0926 EST');
set(gca,'YTickLabel',{''});
set(gca,'XTickLabel',{''});
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.4 0.69  0.28 0.28])

subplot(3,3,3); %LAU3
hold on;
plot (OMC3(2:size(OMC3,1),1),OMC3(2:size(OMC3,1),2),'o','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C3.data(:,1),C3.data(:,2),'g','LineWidth',lwt);
plot (N3.data(:,1),N3.data(:,2),'r--','LineWidth',lwt);
plot (S3.data(:,1),S3.data(:,2),'k','LineWidth',lwt/2);
xlim([8 30])
ylim([0 20])
title('30 Aug 2008 0511 EST');
set(gca,'YTickLabel',{''});
set(gca,'XTickLabel',{''});
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.7 0.69 0.28 0.28])

subplot(3,3,4);%LAU1
hold on;
plot (OSTS1(2:size(OSTS1,1),1),OSTS1(2:size(OSTS1,1),2),'x','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C1.data(:,1),C1.data(:,3),'g','LineWidth',lwt);
plot (N1.data(:,1),N1.data(:,3),'r--','LineWidth',lwt);
plot (S1.data(:,1),S1.data(:,3),'k','LineWidth',lwt/2);
xlim([5 15])
ylim([0 20])
ylab{1}='STS';
set(gca,'XTickLabel',{''});
...
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.1 0.39 0.28 0.28])
hl=legend('Observed', 'C2-SZ', 'N2-SZ','1-SZ');
set(hl,'fontsize',sz)

subplot(3,3,5); %LAU2
hold on;
plot (OSTS2(2:size(OSTS2,1),1),OSTS2(2:size(OSTS2,1),2),'x','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C2.data(:,1),C2.data(:,3),'g','LineWidth',lwt);
plot (N2.data(:,1),N2.data(:,3),'--r','LineWidth',lwt/2);
plot (S2.data(:,1),S2.data(:,3),'k','LineWidth',lwt/2);
xlim([0 15])
ylim([0 20])
set(gca,'YTickLabel',{''});
set(gca,'XTickLabel',{''});
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.4 0.39  0.28 0.28])

subplot(3,3,6); %LAU3
hold on;
plot (OSTS3(2:size(OSTS3,1),1),OSTS3(2:size(OSTS3,1),2),'x','MarkerSize',5,'Color',[.5 .5 .5],'MarkerFaceColor',[.5 .5 .5]);
plot (C3.data(:,1),C3.data(:,3),'g','LineWidth',lwt);
plot (N3.data(:,1),N3.data(:,3),'--r','LineWidth',lwt);
plot (S3.data(:,1),S3.data(:,3),'k','LineWidth',lwt/2);
xlim([8 30])
ylim([0 20])
set(gca,'YTickLabel',{''});
set(gca,'XTickLabel',{''});
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.7 0.39  0.28 0.28])

subplot(3,3,7);%LAU1
hold on;
plot (C1.data(:,1),C1.data(:,4),'g','LineWidth',lwt);
plot (N1.data(:,1),N1.data(:,4),'r--','LineWidth',lwt);
plot (S1.data(:,1),S1.data(:,3),'k','LineWidth',lwt/2);
xlim([5 15])
ylim([0 20])
ylab{1}='HTS';
ylabel(ylab,'FontName','Times New Roman','FontSize',sz)
xlabel(xlab,'FontName','Times New Roman','FontSize',sz)
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
get(gca,'Position')
set(gca,'Position',[0.1 0.09  0.28 0.28])
hl = legend('C2-SZ','N2-SZ','1-SZ');
set(hl,'fontsize',sz)

subplot(3,3,8); %LAU2
hold on;
plot (C2.data(:,1),C2.data(:,4),'g','LineWidth',lwt);
plot (N2.data(:,1),N2.data(:,4),'r--','LineWidth',lwt);
plot (S2.data(:,1),S2.data(:,3),'k','LineWidth',lwt/2);
xlim([0 15])
ylim([0 20])
xlabel(xlab,'FontName','Times New Roman','FontSize',sz)
...
set(gca,'FontName','Times New Roman','FontSize',sz)
box on;
set(gca,'Position',[0.4 0.09 0.28 0.28])

subplot(3,3,9); %LAU3
hold on;
plot (C3.data(:,1),C3.data(:,4),'g','LineWidth',lwt);
plot (N3.data(:,1),N3.data(:,4),'r--','LineWidth',lwt);
plot (S3.data(:,1),S3.data(:,3),'k','LineWidth',lwt/2);
xlim([8 30])
ylim([0 20])
set(gca,'YTickLabel',{''});
xlabel(xlab,'FontName','Times New Roman','FontSize',sz)
set(gca,'FontName','Times New Roman','FontSize',sz)
set(gca,'Position',[0.7 0.09  0.28 0.28])
box on;
...
set(gcf,'PaperType','usLetter','PaperOrientation','portrait',...
        'PaperUnits','Inches','PaperPositionMode','Manual') 
set(gcf,'PaperPosition',[0 0 8 8],'Position',[100 100 800 800]) 
print('-depsc2','-r600','Figure4.eps')
print('-dpng','-r200','Figure4.png')
...
figure(11);
subplot(2,3,1)%
plot (Nest.data(:,1),10*Nest.data(:,11),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),10*Comp.data(:,11),'r--','LineWidth',1.5);
...
title('a)')
p = get(gca,'pos')
set(gca,'pos',[0.08 0.55 0.25 0.35]);
hl = legend('N2-SZ','C2-SZ','1-SZ')
set(hl,'Location','SouthWest','fontsize',sz)

subplot(2,3,2)%
plot (Nest.data(:,1),1000*Nest.data(:,12),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),1000*Comp.data(:,12),'r--','LineWidth',1.5);
...
title('b)')
p = get(gca,'pos')
set(gca,'pos',[0.4 0.55 0.25 0.35]);

subplot(2,3,3)%
plot (Nest.data(:,1),10000*Nest.data(:,13),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),10000*Comp.data(:,13),'r--','LineWidth',1.5);
...
title('c)')
p = get(gca,'pos')
set(gca,'pos',[0.72 0.55 0.25 0.35]);

subplot(2,3,4)%
plot (Nest.data(:,1),10*Nest.data(:,6),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),10*Comp.data(:,6),'r--','LineWidth',1.5);
...
title('d)')
p = get(gca,'pos')
set(gca,'pos',[0.08 0.1 0.25 0.35]);

subplot(2,3,5)%
plot (Nest.data(:,1),1000*Nest.data(:,7),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),1000*Comp.data(:,7),'r--','LineWidth',1.5);
...
title('e)')
p = get(gca,'pos')
set(gca,'pos',[0.4 0.1 0.25 0.35]);

subplot(2,3,6)%
plot (Nest.data(:,1),1000*Nest.data(:,10),'b','LineWidth',1.5);
hold on;
plot (Comp.data(:,1),1000*Comp.data(:,10),'r--','LineWidth',1.5);
...
title('f)')
p = get(gca,'pos')
set(gca,'pos',[0.72 0.1 0.25 0.35]);

set(gcf,'PaperType','usLetter','PaperOrientation','portrait',...
        'PaperUnits','Inches','PaperPositionMode','Manual') 
set(gcf,'PaperPosition',[0 0 8 4],'Position',[100 100 800 400]) 
print('-depsc2','-r600','Figure6.eps')
print('-dpng','-r200','Figure6.png')
%%
clc;
clear all;
close all;
